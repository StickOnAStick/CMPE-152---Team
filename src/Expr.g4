...
programHeading : PROGRAM identifier (LPAREN identifierList RPAREN)? SEMICOLON | UNIT identifier SEMICOLON | PROGRAM identifier SEMICOLON ;
...
typeIdentifier : identifier | (CHAR | BOOLEAN | INTEGER | REAL | STRING) ;
...
fieldList : fixedPart (SEMICOLON variantPart)? | variantPart ;
...
simpleStatement : assignmentStatement | procedureStatement | gotoStatement | emptyStatement_ ;
...
unsignedConstant : unsignedNumber | constantChr | string | NIL ;
